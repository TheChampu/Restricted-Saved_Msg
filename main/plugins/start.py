...
async def start(event):
    ...
    buttons = [
        [Button.url("Join Channel", url="https://t.me/akaChampu")],
        [Button.url("Contact Me", url="https://t.me/TheChampu")],
    ]
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [CHAMPU](https://t.me/TheChampuBot)**__"  # Set caption to the title of the video
